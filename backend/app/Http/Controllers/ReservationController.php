...

{
    public function reservation(Request $request)
    {
        ...
        if ($existingReservation) {
            return response()->json(['error' => 'Cet email a déjà effectué une réservation pour cette formation.'], 400);
        }
        ...
        return response()->json(['message' => 'Modules client, réservation et réservation ajoutés avec succès'], 200);
    }
...
foreach ($reservations as $reservation) {
  $clientsWithPrices = $reservation->prix;
        ...
        Mail::to('Touildigicom@gmail.com')->send(new ReservationMail($request, $formationName, $modulesNames,$clientsWithPrices));
