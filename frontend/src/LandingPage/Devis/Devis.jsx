...
export default function Devis() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${apiUrl}/api/send-devis`, DevisData);
  ...
  return (
    <Fragment>
      <div
        className={langue == "fr" ? "parentDevis" : "parentDevis parentDevisAr"}
      >
        <div className="parentTextDevis">
          <div className="colLeftDevis">
            ...
            <h1
              className={
                langue == "fr"
                  ? "h1LandingPage h1LandingPageDevis"
                  : "h1LandingPage h1LandingPageDevis h1LandingPageAr"
              }
            >
              {Devis.title}
            </h1>
          ...
          <div
            className={
              langue == "fr" ? "colRightDevis" : "colRightDevis colRightDevisAr"
            }
          >
        ...
        <div
          className={
            langue == "fr"
              ? "parentFormDevis"
              : "parentFormDevis parentFormDevisAr"
          }
        >
          <div
            className={
              langue == "fr" ? "colFormDevis" : "colFormDevis colFormDevisAr"
            }
          >
                ...
                <tbody>
                  <tr>
                    <td className="devisInp">
                      <input
                        type="text"
                        placeholder={Devis.nom}
                        className="inputDevis"
                  ...
                  <tr>
                    <td className="devisInp">
                      <select name="service_devis" onChange={handleChange}>
          ...
          <div className="colFormPicDevis">
            ...
            <div className="colInfoClient">
              <h4>Client</h4>
              <p>
                Nom de client : {DevisData.nom_devis} {DevisData.prenom_devis}
              </p>
            ...
            <div className="colTabledevis">
              <table className="tableDevis" cellspacing="0">
                ...
                <tbody>
                  <tr>
                    <td>
                      <div className="spaceDevisTd"></div>
                    </td>
                    <td>
                      <div className="spaceDevisTd"></div>
                    </td>
            ...
            <div className="colInformationDevisTouil">
              <ul>
                <li>
                  <i className="bx bxs-phone"></i> +212 628 79 45 01{" "}
                </li>
                <li>
                  <i className="bx bx-envelope"></i> contact@touildiicom.ma{" "}
                </li>
                <li>
                  <i className="bx bx-world"></i> touildigicom.ma
                </li>
              </ul>
            </div>
          </div>
