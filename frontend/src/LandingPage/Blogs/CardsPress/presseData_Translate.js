...
export const PresseTouilFr = {
    title : 'TOUIL DIGICOM DANS LA PRESS',
    button : 'lire la suite ',
    description : 'Rejoignez notre newsletter pour recevoir toutes nos publications et actualités',
    CardsPress : [
        {
            id : 1,
...
export const PresseTouilAr = {
    title : 'تويل ديجيكوم في الصحافة',
    button : 'اقرأ المزيد',
    description : 'انضم إلى النشرة الإخبارية لدينا لتلقي جميع منشوراتنا وأخبارنا',
    CardsPress : [
        {
            id : 1,
            IconsPress : 'medi1tv.png',
