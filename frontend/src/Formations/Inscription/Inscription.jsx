...
export const Inscription = () => {
    ...
    const {valuesModel,selectAll,setvalidationScreen,validationScreen,reserved,langue} = useContext(LangueContext)
   ...
   const [responsemessage,setresponsemessage] = useState('')
    ...
    const Inscription = Translate.inscription.find((lang)=>(
        lang.id == langue
      ))
    ...
    const handleSubmit = async (e) =>{
     ...
     try {
        const response = await axios.post('http://127.0.0.1:8000/api/sendmailvalidation', {
                email: formData.email,
                formationId: formData.formationId 
        });
        if(response.data.message === "Client has already reserved this formation"){
            setvalidationScreen(false)
            setresponsemessage(response.data.message);
        }else if(response.data.message === "Client has not reserved this formation"){
    ...
    const validateForm = () => {
        ...
        if (isNaN(formData.numero_whatsapp)) {
            validationErrors.numero_whatsapp = 'Le numéro Whatsapp doit être un nombre';
        }
    ...
    const getallformations = async () => {
        try {
            axios.get('http://127.0.0.1:8000/api/getallformations')
                .then(response => {
...
{!validationScreen ? (
        ...
        <div className='inscriptionParent'  >
           ...
           <div className='inscription-content' id={clicked && !validationScreen ? "after-clicked" : ''}>
            ...
            <tr>
                <td>
                    <div class="coolinput">
                        ...
                        />
                {Errors.prenom&& <span className='errorMessage'>{Errors.prenom}<i className='bx bxs-error'></i></span>} 
                ...
                <td>
                    <div class="coolinput">
                        <input
                            ...
                            onChange={handleChange}
                        />
                {Errors.nom&& <span className='errorMessage'>{Errors.nom}<i className='bx bxs-error'></i></span>} 
                ...
                <td>
                    <div class="coolinput">
                        <input
                            ...
                            onChange={handleChange}
                        />
                {Errors.telephone&& <span className='errorMessage'>{Errors.telephone}<i className='bx bxs-error'></i></span>} 
                ...
                <td>
                    <div class="coolinput">
                        <input
                            ...
                            onChange={handleChange}
                        />
                {Errors.date_naissance&& <span className='errorMessage'>{Errors.date_naissance}<i className='bx bxs-error'></i></span>} 
                ...
                <td>
                    <div class="coolinput">
                        <input
                            ...
                            onChange={handleChange}
                        />
                {Errors.numero_whatsapp&& <span className='errorMessage'>{Errors.numero_whatsapp}<i className='bx bxs-error'></i></span>} 
                ...
                <td>
                    <div class="coolinput">
                        <input
                            ...
                            onChange={handleChange}
                        />
                {Errors.niveau_etude&& <span className='errorMessage'>{Errors.niveau_etude}<i className='bx bxs-error'></i></span>} 
                ...
                <td>
                    <div class="coolinput">
                        <input
                            ...
                            onChange={handleChange}
                        />
                {Errors.experiences_formatives&& <span className='errorMessage'>{Errors.experiences_formatives}<i className='bx bxs-error'></i></span>} 
    ...
    <select
        ...
        onChange={handleChange}
    >
        <option value="" disabled selected>{Inscription.select}</option>
    ...
    {Errors.ville && <span className="errorMessage">{Errors.ville}<i className="bx bxs-error"></i></span>}
</div>
    ...
    <button className='reserveBtn' type="submit">{Inscription.submit}</button>
</form>


                 </div>
            <div className='inscription-affiche' id={clicked && !validationScreen ? "after-clicked" : ''}>
                <img className='affiche' src="/assets/formations/formation1.png" alt="" />
                 </div>
