...
export default function FormateurDashboard() {
  ...
  function deleteFormateur(id) {
    if (window.confirm("Êtes-vous sûr de vouloir supprimer ce formateur?")) {
      axios
        .delete(`${apiUrl}/api/formateurs/${id}`)
        .then((response) => {
      ...
      <div className="parentHomeDashboard">
        ...
        <div className="TitleDashboard formations">
          ...
          <div>
            <button
              ...
              title="Ajoute Formations"
              onClick={openAddFormateur}
            >
        ...
        <div className="rowControlsFormation">
          ...
          >
            <input
              type="text"
              placeholder="Chercher(Nom, Prénom, Email, Spécialité) ..."
              value={searchQuery}
            ...
            <tbody>
              {sortedFormateurs.map((formateur, index) => (
                <tr key={index}>
                  ...
                  <td>
                    <span className="spanNomUppercase">{formateur.nom}</span>
                  </td>
                  ...
                  <td className="tdActions">
                    <div>
                      <button
                        className="btnEdit"
                        onClick={() => openEditFormateur(formateur.id)}
                      >
        ...
        {toggleEditFormateur && (
          <ModalEditFormateur
            ...
            onClose={closeEditFormateur}
            setResponseMessage={setResponseMessage}
          />
        )}
        {togglePoubelle && (
          <ModalTrashedFormateurs
            onClose={closeTrashedFormateur}
            setResponseMessage={setResponseMessage}
          />
        )}
      </div>
